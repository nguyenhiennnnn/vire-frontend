...
export interface SocketFriendRequestSentPayload {
  friendship: Friendship;
  sender: UserBasic; // actor
}

export interface SocketFriendAcceptedPayload {
  friendship: Friendship;
  accepter: UserBasic & { friendsCount: number };
  requester: UserBasic & { friendsCount: number };
}
...
export interface SocketFriendBlockedPayload {
  blockerId: string;
  blockedId: string;
  wasFriends: boolean;
}

export interface SocketFriendUnblockedPayload {
  unblockerId: string;
  unblockedId: string;
}
...
export interface SocketStoryCreatedByMePayload {
  story: Story;
  user: UserBasic;
}

export interface SocketStoryDeletedByMePayload {
  storyId: string;
  userId: string;
}
...
export interface SocketPostCreatedByMePayload {
  post: Post;
}
